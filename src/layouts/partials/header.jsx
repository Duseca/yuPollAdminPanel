        ...
        <nav className="text-gray-350">
          <div className=" flex flex-wrap items-center justify-between px-4 py-9 sm:p-8">
            ...
            <div className="relative" id="navbar-default">
              ...
              <div className={`z-50 ${drop ? null : 'hidden'} absolute w-full px-4 my-4 text-gray-950 border font-medium list-none bg-white divide-y divide-gray-100 rounded-lg shadow`}>
